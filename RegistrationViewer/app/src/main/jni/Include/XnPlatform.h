...
//---------------------------------------------------------------------------
		...
		#if _MSC_VER > 1800 // After MSVC8 (2012)
			#error Xiron Platform Abstraction Layer - Win32 - Microsoft Visual Studio versions above 2012 (11.0) are not supported!
		#endif
	#endif
...
#elif (linux && (i386 || __x86_64__ || __i386__))
